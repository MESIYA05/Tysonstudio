  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await Swal.fire({
        ...
        text: 'Thank you for choosing TYSON STUDIO. We will get back to you shortly to prepare for your child portrait session.',
      ...
      <section className="service-hero-banner">
        <div className="container">
          ...
          <h1 className="service-hero-title" data-aos="fade-up">
            INSTA BABY SHOOT BOOKING <span className="text-accent">.</span>
          </h1>
          <p className="service-hero-sub" data-aos="fade-up" data-aos-delay="100">
            Book a fun, comfortable, and gentle photoshoot for your baby or toddler.
          </p>
        </div>
      </section>
        ...
        <div className="booking-layout-grid">
          ...
          <div className="booking-package-card" data-aos="fade-right">
            <div>
              <div className="booking-package-header">
                ...
                <h2 className="booking-package-title">Insta Baby Shoot</h2>
                <p className="body-sm">Essential kids photography with themed studio setups.</p>
              </div>
              ...
              <div className="booking-package-features">
                ...
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                  <span>2 Setups & Costume Changes in 2 Hours</span>
                </div>
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                ...
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                  <span>Parent & Sibling Portraits Included</span>
                </div>
              </div>

              {/* Studio Assured Benefits */}
              <div className="booking-benefits-box">
                <span className="booking-benefits-title">✦ Child-Safe Studio Guarantees</span>
                <p className="booking-benefits-desc">
                  • 100% Refund guarantee on cancellations within 48 hours.<br/>
                  • Baby-safe organic sanitized props & warm studio setup.<br/>
                  • Flexible timing around your baby's sleep and feeding routine.
                </p>
              </div>
            </div>
            ...
            <div className="booking-pricing-box">
              ...
              <span className="booking-price-val">₹ 21,999</span>
            </div>
          </div>
          ...
          <div className="booking-form-card" data-aos="fade-left">
            <div>
              ...
              <p className="booking-form-intro">Provide details to schedule your baby photoshoot.</p>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="booking-form-group">
                  <label className="booking-form-label" htmlFor="message">Baby's Age & Theme Preferences *</label>
                  <textarea
                    id="message"
                    name="message"
                    value={formData.message}
                    onChange={handleChange}
                    placeholder="Please share baby age/milestone, preferred costume themes, nap schedule..."
                    minLength={10}
                    className="booking-form-input"
                    required
                  />
