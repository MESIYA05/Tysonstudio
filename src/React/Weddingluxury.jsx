  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await Swal.fire({
        ...
        text: 'Thank you for choosing TYSON STUDIO. Our executive team will reach out to schedule your luxury consultation.',
      ...
      <section className="service-hero-banner">
        <div className="container">
          ...
          <h1 className="service-hero-title" data-aos="fade-up">
            LUXURY WEDDING BOOKING <span className="text-accent">.</span>
          </h1>
          <p className="service-hero-sub" data-aos="fade-up" data-aos-delay="100">
            Cinematic high-production coverage with senior artists, drone cinematography, and dedicated direction.
          </p>
        </div>
      </section>
          ...
          <div className="booking-package-card" data-aos="fade-right">
            <div>
              <div className="booking-package-header">
                <span className="booking-package-sub">Flagship Tier</span>
                <h2 className="booking-package-title">Luxury Wedding</h2>
                <p className="body-sm">Uncompromising production quality for discerning celebrations.</p>
              </div>

              <div className="booking-package-features">
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                  <span>5 Functions covered by a 5-member elite team</span>
                </div>
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                ...
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                  <span>1,000+ Master Retouched Heirloom Images & Drone footage</span>
                </div>
              </div>

              {/* Studio Assured Benefits */}
              <div className="booking-benefits-box">
                <span className="booking-benefits-title">✦ Flagship Inclusions & VIP Support</span>
                <p className="booking-benefits-desc">
                  • 100% Refund guarantee on cancellations within 48 hours of booking.<br/>
                  • Dedicated Creative Producer + On-site Director throughout all events.<br/>
                  • 4K Ultra HD Delivery & raw archive delivery on custom SSD.
                </p>
              </div>
            </div>
            ...
            <div className="booking-pricing-box">
              <div>
                ...
                <div style={{ textDecoration: 'line-through', color: 'var(--text-muted)', fontSize: '0.85rem' }}>₹ 2,50,000</div>
              </div>
              <span className="booking-price-val">₹ 2,20,000</span>
            </div>
          </div>
