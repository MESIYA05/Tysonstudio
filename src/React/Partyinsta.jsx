  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await Swal.fire({
        ...
        text: 'Thank you for choosing TYSON STUDIO. We will get back to you shortly to confirm your event coverage.',
      ...
      <section className="service-hero-banner">
        <div className="container">
          ...
          <h1 className="service-hero-title" data-aos="fade-up">
            PARTY INSTA SHOOT BOOKING <span className="text-accent">.</span>
          </h1>
          <p className="service-hero-sub" data-aos="fade-up" data-aos-delay="100">
            Book professional event photography for birthday parties, anniversaries, and social gatherings.
          </p>
        </div>
      </section>
        ...
        <div className="booking-layout-grid">
          ...
          <div className="booking-package-card" data-aos="fade-right">
            <div>
              <div className="booking-package-header">
                ...
                <p className="body-sm">Essential event photography with fast digital delivery.</p>
              </div>

              <div className="booking-package-features">
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                  <span>100 Master Edited Event Images</span>
                </div>
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                  <span>2 Hours Active Party Coverage</span>
                </div>
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                ...
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                  <span>Full Frame Cameras with Prime & Wide Angle Lenses</span>
                </div>
              </div>

              {/* Studio Assured Benefits */}
              <div className="booking-benefits-box">
                <span className="booking-benefits-title">✦ Event Assured Guarantees</span>
                <p className="booking-benefits-desc">
                  • 100% Refund guarantee on cancellations within 48 hours.<br/>
                  • Fast-turnaround digital link delivery within 48 to 72 hours.<br/>
                  • Crisp low-light flash balancing & candid guest coverage.
                </p>
              </div>
            </div>
            ...
            <div className="booking-pricing-box">
              <div>
                ...
                <div style={{ textDecoration: 'line-through', color: 'var(--text-muted)', fontSize: '0.85rem' }}>₹ 8,999</div>
              </div>
              <span className="booking-price-val">₹ 6,999</span>
            </div>
          </div>
          ...
          <div className="booking-form-card" data-aos="fade-left">
            <div>
              ...
              <p className="booking-form-intro">Provide details to schedule your party photography.</p>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="booking-form-group">
                  <label className="booking-form-label" htmlFor="message">Event Details & Venue *</label>
                  <textarea
                    id="message"
                    name="message"
                    value={formData.message}
                    onChange={handleChange}
                    placeholder="Please specify party type (birthday, anniversary, etc.), venue location, start time..."
                    minLength={10}
                    className="booking-form-input"
                    required
                  />
