  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await Swal.fire({
        ...
        text: 'Thank you for choosing TYSON STUDIO. We will get back to you shortly to organize your Maternity session.',
      ...
      <section className="service-hero-banner">
        <div className="container">
          ...
          <h1 className="service-hero-title" data-aos="fade-up">
            INSTA MOM SHOOT BOOKING <span className="text-accent">.</span>
          </h1>
          <p className="service-hero-sub" data-aos="fade-up" data-aos-delay="100">
            Book an intimate and gentle maternity photoshoot with our specialist team.
          </p>
        </div>
      </section>
        ...
        <div className="booking-layout-grid">
          ...
          <div className="booking-package-card" data-aos="fade-right">
            <div>
              <div className="booking-package-header">
                ...
                <h2 className="booking-package-title">Insta Mom Shoot</h2>
                <p className="body-sm">Comfortable studio or outdoor portrait session.</p>
              </div>

              <div className="booking-package-features">
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                  <span>15 Curated & Fine Art Master Edited Images</span>
                </div>
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                  <span>2 Hours Relaxed Shoot Duration</span>
                </div>
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                  <span>1 Location & Up to 2 Wardrobe Changes</span>
                </div>
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
              ...
              <div className="booking-benefits-box">
                <span className="booking-benefits-title">✦ Studio Guarantees & Comfort</span>
                <p className="booking-benefits-desc">
                  • 100% Refund on cancellations within 48 hours.<br/>
                  • Extra comfort breaks, temperature-controlled studio environment.<br/>
                  • Partner & sibling portraits included at no additional charge.
                </p>
              </div>
            </div>
            ...
            <div className="booking-pricing-box">
              <div>
                ...
                <div style={{ textDecoration: 'line-through', color: 'var(--text-muted)', fontSize: '0.85rem' }}>₹ 27,999</div>
              </div>
              <span className="booking-price-val">₹ 25,999</span>
            </div>
          </div>
          ...
          <div className="booking-form-card" data-aos="fade-left">
            <div>
              ...
              <p className="booking-form-intro">Provide your details to schedule your maternity session.</p>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="booking-form-group">
                  <label className="booking-form-label" htmlFor="message">Pregnancy Week & Preferences *</label>
                  <textarea
                    id="message"
                    name="message"
                    value={formData.message}
                    onChange={handleChange}
                    placeholder="Please mention your pregnancy week, preferred indoor/outdoor vibe, etc..."
                    minLength={10}
                    className="booking-form-input"
                    required
                  />
