...
const Materluxury = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const dataToSend = {
      ...formData,
      service: 'maternity [luxury shoot]',
      amount: 34999,
    };
    ...
    try {
      ...
      await Swal.fire({
        ...
        text: 'Thank you for choosing TYSON STUDIO. We will get back to you shortly to coordinate your Super Mom maternity session and wardrobe styling.',
      ...
      <section className="service-hero-banner">
        <div className="container">
          ...
          <h1 className="service-hero-title" data-aos="fade-up">
            SUPER MOM LUXURY BOOKING <span className="text-accent">.</span>
          </h1>
          <p className="service-hero-sub" data-aos="fade-up" data-aos-delay="100">
            Premium maternity experience including fine-art styling, designer gown, partner portraits, and 4K reels.
          </p>
        </div>
      </section>
        ...
        <div className="booking-layout-grid">
          ...
          <div className="booking-package-card" data-aos="fade-right">
            <div>
              <div className="booking-package-header">
                <span className="booking-package-sub">Premium Maternity Tier</span>
                <h2 className="booking-package-title">Super Mom Shoot</h2>
                <p className="body-sm">Photography + 2 cinematic reels + designer maternity gown included.</p>
              </div>
              ...
              <div className="booking-package-features">
                ...
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                  <span>Partner & Family Portraits Included</span>
                </div>
              </div>

              {/* Studio Assured Benefits */}
              <div className="booking-benefits-box">
                <span className="booking-benefits-title">✦ Exclusive Maternity Inclusions</span>
                <p className="booking-benefits-desc">
                  • 100% Refund guarantee on cancellations within 48 hours of booking.<br/>
                  • Professional wardrobe stylist + curated designer gown selection.<br/>
                  • Edited 4K fine-art prints digital gallery delivered in 72 hours.
                </p>
              </div>
            </div>
          ...
          <div className="booking-form-card" data-aos="fade-left">
            <div>
              ...
              <p className="booking-form-intro">Provide your details to schedule your luxury maternity session.</p>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="booking-form-group">
                  <label className="booking-form-label" htmlFor="message">Pregnancy Details & Gown Sizing *</label>
                  <textarea
                    id="message"
                    name="message"
                    value={formData.message}
                    onChange={handleChange}
                    placeholder="Please mention your pregnancy week, gown preferences, location ideas..."
                    minLength={10}
                    className="booking-form-input"
                    required
                  />
