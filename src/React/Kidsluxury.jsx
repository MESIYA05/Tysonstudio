  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await Swal.fire({
        ...
        text: 'Thank you for choosing TYSON STUDIO. We will get back to you shortly to coordinate your Super Baby session and creative sets.',
      ...
      <section className="service-hero-banner">
        <div className="container">
          ...
          <h1 className="service-hero-title" data-aos="fade-up">
            SUPER BABY LUXURY BOOKING <span className="text-accent">.</span>
          </h1>
          <p className="service-hero-sub" data-aos="fade-up" data-aos-delay="100">
            Premium kids photography experience featuring 4 themed fantasy sets, 30 edited photos, and 3 viral 4K reels.
          </p>
        </div>
      </section>
        ...
        <div className="booking-layout-grid">
          ...
          <div className="booking-package-card" data-aos="fade-right">
            <div>
              <div className="booking-package-header">
                <span className="booking-package-sub">Flagship Kids Tier</span>
                <h2 className="booking-package-title">Super Baby Shoot</h2>
                <p className="body-sm">Photography + 3 social video reels + custom themed wardrobe.</p>
              </div>

              <div className="booking-package-features">
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                  <span>30 Master Retouched Baby Portrait Images</span>
                </div>
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                ...
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                  <span>4 Themed Studio Setups & Costumes</span>
                </div>
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                ...
                <div className="booking-feature-row">
                  <span className="booking-feature-icon">✦</span>
                  <span>Complete Family Portrait Segment Included</span>
                </div>
              </div>

              {/* Studio Assured Benefits */}
              <div className="booking-benefits-box">
                <span className="booking-benefits-title">✦ Flagship Inclusions & Family Keepsakes</span>
                <p className="booking-benefits-desc">
                  • 100% Refund guarantee on cancellations within 48 hours.<br/>
                  • Custom handcrafted themed backdrops & baby styling assistant.<br/>
                  • High-resolution digital album + 3 edited cinematic reels delivered in 72h.
                </p>
              </div>
            </div>
            ...
            <div className="booking-pricing-box">
              <div>
                ...
                <div style={{ textDecoration: 'line-through', color: 'var(--text-muted)', fontSize: '0.85rem' }}>₹ 39,999</div>
              </div>
              <span className="booking-price-val">₹ 34,999</span>
            </div>
          </div>
          ...
          <div className="booking-form-card" data-aos="fade-left">
            <div>
              ...
              <p className="booking-form-intro">Provide details to schedule your luxury baby photoshoot.</p>

              <form onSubmit={handleSubmit}>
                <div className="booking-form-group">
                  <label className="booking-form-label" htmlFor="name">Parent's Full Name *</label>
                  <input
                    type="text"
                    id="name"
                    name="name"
                ...
                <div className="booking-form-group">
                  <label className="booking-form-label" htmlFor="message">Baby Age, Theme & Reel Concept Ideas *</label>
                  <textarea
                    id="message"
                    name="message"
                    value={formData.message}
                    onChange={handleChange}
                    placeholder="Please share baby age, favorite cartoon/fairytale themes, music ideas..."
                    minLength={10}
                    className="booking-form-input"
                    required
                  />
